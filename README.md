...
万能导是一个多平台知识库 Markdown 导入导出工具，目前支持飞书、语雀、阿里云 Thoughts、印象笔记、有道云笔记、为知笔记、OneNote、知识星球、ima 知识库、钉钉文档、WPS 文档、息流、Obsidian、Notion、知乎、CSDN、微信公众号、Google Docs 和本地 Markdown 等内容来源与目标平台。
...
| 📄 **Google Docs** | 经 DOCX 转换导入，尽量保留图片、公式和代码样式 |
